...
import { CheckOutlined, ControlOutlined, EditOutlined, PrinterOutlined } from '@ant-design/icons';
import { Button, TableProps, Tooltip } from 'antd';
import Link from 'next/link';
import React from 'react';

export const getColumns = ({ onShowModalEdit }: { onShowModalEdit: any }) => {
    ...
    },
    {
      ...
      render: (_, record) => (
        <div className="flex flex-col items-start gap-2">
          <div>
            <Button  size="small" icon={<EditOutlined />} onClick={() => onShowModalEdit(record)}>
              Details
            </Button>
            <Button
              size="small"
